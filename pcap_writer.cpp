...
//--------------------------------------------------------------------------------
const std::string& PcapWriter::GetLastError()
{
    return this->LastError;
}

//--------------------------------------------------------------------------------
const std::string& PcapWriter::GetFileName()
{
...
bool PcapWriter::WritePacket(const NetworkPacket& packet)
{
    if (!this->PCAPFile)
    {
        return false;
...
bool PcapWriter::WritePacket(pcap_pkthdr* packetHeader, const unsigned char* packetData)
{
